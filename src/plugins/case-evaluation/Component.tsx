...
export interface CaseEvaluationProps {
  practiceAreas?: string[];
}

export const defaultPracticeAreas: string[] = [
...
export default function CaseEvaluation({ practiceAreas = defaultPracticeAreas }: CaseEvaluationProps) {
    ...
    return (
      <div className="bg-white rounded-2xl border border-slate-200 p-8 shadow-sm text-center">
        ...
        <button
          onClick={() => {
            setSubmitted(false);
            setForm({ name: "", email: "", phone: "", area: "", incidentDate: "", description: "", priorAttorney: "No" });
          }}
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          ...
          <div>
            <label className="block text-xs font-semibold text-slate-600 mb-1">
              Previously worked with an attorney?
            </label>
